...
const chatAnswerType = ['recommand_doctor','search_doctor','recommand_hospital','general','markdown']
...
const contrants  = {
    ...
    error_message_506 : "AI 모델의 콘텐츠 정책에 의해 답변할 수 없습니다. 질문 표현을 수정해서 다시 시도해 주세요."
}
